...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
```__Drupal 9 is a cleaned-up version of Drupal 8. It is the same as the last Drupal 8 minor version with our own deprecated code removed and third-party dependencies updated. Most extensions will only need a few changes. Read more about how this is done and what it means.__```
...
```bash
<span style="color: green"> Some green text </span> cp .env.dist .env
<span style="color: green"> Some green text </span> docker-compose up -d
<span style="color: green"> Some green text </span> docker-compose exec php composer install
```
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
